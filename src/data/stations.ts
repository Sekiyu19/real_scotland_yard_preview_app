...
export const stations: Station[] = [
  // ===== 北部エリア =====
  { id: 'akabane_iwabuchi', name: '赤羽岩淵', x: 475, y: 48, type: 'local' },
  ...
  { id: 'sugamo', name: '巣鴨', x: 475, y: 95, type: 'local' },
  ...
  { id: 'asakusa', name: '浅草', x: 980, y: 158, type: 'local' },
  { id: 'kuramae', name: '蔵前', x: 925, y: 195, type: 'local' },
  { id: 'honjo_azumabashi', name: '本所吾妻橋', x: 1058, y: 150, type: 'local' },
  { id: 'oshiage', name: '押上', x: 1108, y: 180, type: 'local' },

  // ===== 中野〜高田馬場 =====
  { id: 'nakano', name: '中野', x: 178, y: 295, type: 'express' },
  { id: 'ochiai', name: '落合', x: 242, y: 308, type: 'local' },
  { id: 'takadanobaba', name: '高田馬場', x: 310, y: 280, type: 'express' },
  ...
  { id: 'jimbocho', name: '神保町', x: 602, y: 382, type: 'local' },
  ...
  { id: 'morishita', name: '森下', x: 965, y: 318, type: 'local' },
  { id: 'hamachou', name: '浜町', x: 935, y: 335, type: 'local' },
  { id: 'kinshicho', name: '錦糸町', x: 1075, y: 248, type: 'local' },
  { id: 'sumiyoshi', name: '住吉', x: 1045, y: 300, type: 'local' },
  ...
  { id: 'nihombashi', name: '日本橋', x: 800, y: 418, type: 'local' },
  { id: 'ningyocho', name: '人形町', x: 828, y: 375, type: 'local' },
  { id: 'suitengumae', name: '水天宮前', x: 872, y: 400, type: 'local' },
  { id: 'kayabacho', name: '茅場町', x: 862, y: 432, type: 'local' },
  { id: 'tokyo', name: '東京', x: 778, y: 482, type: 'express' },
  ...
  { id: 'higashi_ginza', name: '東銀座', x: 802, y: 568, type: 'local' },
  ...
  { id: 'tameike_sanno', name: '溜池山王', x: 478, y: 562, type: 'local' },
  { id: 'akasaka', name: '赤坂', x: 515, y: 575, type: 'local' },
  { id: 'kokkai_gijidomae', name: '国会議事堂前', x: 605, y: 550, type: 'local' },
  ...
  { id: 'daimon', name: '大門', x: 675, y: 640, type: 'local' },
  ...
  { id: 'meiji_jingumae', name: '明治神宮前', x: 278, y: 555, type: 'local' },
  ...
  { id: 'gotanda', name: '五反田', x: 290, y: 740, type: 'local' },

  // ===== 代々木上原エリア =====
  { id: 'yoyogi_uehara', name: '代々木上原', x: 148, y: 530, type: 'local' },
  { id: 'yoyogi_koen', name: '代々木公園', x: 208, y: 530, type: 'local' },

  // ===== 門前仲町〜豊洲エリア =====
  { id: 'monzen_nakacho', name: '門前仲町', x: 895, y: 470, type: 'local' },
  { id: 'kiyosumi_shirakawa', name: '清澄白河', x: 945, y: 420, type: 'local' },
  { id: 'tsukishima', name: '月島', x: 905, y: 575, type: 'local' },
  { id: 'toyosu', name: '豊洲', x: 948, y: 572, type: 'local' },
  { id: 'tatsumi', name: '辰巳', x: 990, y: 572, type: 'local' },
  { id: 'shin_kiba', name: '新木場', x: 1040, y: 572, type: 'local' },
];
